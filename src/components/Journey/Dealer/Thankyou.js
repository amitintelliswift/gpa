                            ...
                            <div className={`whiteCard ${classes.root}`}>
                                ...
                                <div className='thankyouWrap'>
                                    ...
                                    <div className='thankyouInfo'>
                                        <Snackbars
                                            type="success"
                                            message="Your application has been received. The policy will be issued on successful payment . A Payment Link has been emailed to your registered email address."
                                        />
                                    </div>
